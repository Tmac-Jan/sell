        ...
        <div class="container-fluid">
                    ...
                    <table class="table table-bordered table-condensed">
                        ...
                        <tr>
                           ...
                           <#--<td><img height="100" width="100" src="${productInfo.productIcon}" alt=""></td>-->
                            ...
                            <td>
                                <#if buyerComplainInfo.getBuyerComplainEnum().getStatus() != 3>
                                    <a href="/sell/support/buyerComplain/index?id=${buyerComplainInfo.id}">回复投诉</a>
                                <#else>
                                    <a href="/sell/support/buyerComplain/index?id=${buyerComplainInfo.id}">Support已回复</a>
                                </#if>
                            </td>
                        </tr>
                        </#list>
            ...
            <#--分页-->
                <div class="col-md-12 column">
                    ...
                    <#else>
                        <li><a href="/sell/support/buyerComplain/list?page=${currentPage - 1}&size=${size}">上一页</a></li>
                    </#if>
                    ...
                    <#list 1..buyerComplainPage.getTotalPages() as index>
                        ...
                        <#else>
                            <li><a href="/sell/support/buyerComplain/list?page=${index}&size=${size}">${index}</a></li>
                        </#if>
                    </#list>
                    ...
                    <#else>
                        <li><a href="/sell/support/buyerComplain/list?page=${currentPage + 1}&size=${size}">下一页</a></li>
                    </#if>
                    </ul>
                </div>
            </div>

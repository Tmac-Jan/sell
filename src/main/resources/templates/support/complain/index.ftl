        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <form role="form" method="post" action="/sell/support/buyerComplain/reply">
                        ...
                        <div class="form-group">
                            <label>店家回复</label>
                            <input readonly  unselectable="on" name="shopReply" type="text" class="form-control" value="${(buyerComplain.shopReply)!''}"/>
                        </div>
                        <div class="form-group">
                            <label>创建时间</label>
                        ...
                        <#if (buyerComplain.supportReply??)>
                            <a href="/sell/support/buyerComplain/list">返回</a>
                           <#else>
